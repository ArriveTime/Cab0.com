...
<head>
    ...
    <style>
        ...
        .button { background: #ffcc00; color: #000; padding: 25px; width: 100%; border: none; border-radius: 12px; font-size: 24px; font-weight: bold; width: 100%; }
    </style>
</head>
<body>
    ...
    <div class="footer">
        <button class="button">REQUEST PROTOTYPE</button>
    </div>
</body>
</html>
