...
<div class="page active" id="pg0">
  <div class="p1-body">
    ...
    <div style="background:#161616; border:1px solid #252525; border-radius:16px; padding:18px; display:flex; align-items:center; gap:12px; margin-bottom:25px; cursor:pointer" onclick="goTo(1)">
      ...
      <span style="color:#666">Set destination...</span>
    </div>
...
<div class="page" id="pg1">
  <div style="padding:40px 26px;">
    ...
    <div style="background:#161616; border:1px solid #222; border-radius:18px; padding:20px; margin-top:20px;">
      <input type="text" placeholder="Address, City, or Business Name" style="width:100%; background:#000; border:1.5px solid #333; color:#fff; padding:15px; border-radius:11px; outline:none; font-size:16px;">
    </div>
    <div style="background:var(--y); color:#000; padding:20px; border-radius:15px; text-align:center; font-weight:700; margin-top:20px; cursor:pointer;" onclick="goTo(2)">Compare Rates →</div>
  </div>
</div>
...
<div class="page" id="pg2">
  ...
  <div class="p3-footer">
    <div><div id="sel-name" style="font-weight:700; font-size:15px;">Select Option</div><div style="font-size:11px; color:#666;">Secure Official Link</div></div>
...
// SECURE HTTPS UNIVERSAL LINKS
var LINKS = {
  'uber': 'https://m.uber.com/ul/',
  'lyft': 'https://www.lyft.com/ride?id=lyft',
  'waymo': 'https://waymo.com/waymo-one/',
  'zoox': 'https://zoox.com/',
  'uber_black': 'https://m.uber.com/ul/?action=setPickup&product_id=uberblack',
  'lyft_lux': 'https://www.lyft.com/ride?id=lyft_lux',
